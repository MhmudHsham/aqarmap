...
@section("page_title", "Article Data")
        ...
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green sbold uppercase">Article Data</span>
                </div>
            </div>
            <div class="portlet-body">
                @if($id == 0)
                @php($action = url('/admin/articles/store'))
                @else
                @php($action = url('/admin/articles/update'). "/" . $id)
                @endif
                <!-- BEGIN FORM   -->
                <form action="{{ $action }}" class="form-horizontal" id="articles_form" method="post">
                    {{ csrf_field() }}
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group form-md-line-input">
                            <label class="col-md-2 control-label" for="form_control_1">Category
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <textarea cols="20" class="form-control" rows="6" name="content" id="content"></textarea>
                                <div class="form-control-focus"> </div>
                                <span class="help-block">Enter Content</span>
                            </div>
                        </div>
                        <div class="form-group form-md-line-input">
